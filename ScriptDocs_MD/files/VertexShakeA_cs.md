# File: VertexShakeA.cs
[< トップページへ戻る](../Index.md)

> **Path:** `Assets/TextMesh Pro/Examples & Extras/Scripts/VertexShakeA.cs`

<a id='VertexShakeA'></a>
## Class VertexShakeA
**Namespace:** `TMPro.Examples`<br>
**Signature:** `VertexShakeA : MonoBehaviour`
...
| `public` | ScaleMultiplier | `Single` |  |  |
| `public` | RotationMultiplier | `Single` |  |  |
...
| `private` | AnimateVertexColors |  | `IEnumerator` | Method to animate vertex colors of a TMP Text object. |
