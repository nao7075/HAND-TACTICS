# File: TMP_FrameRateCounter.cs
[< トップページ](../index.md) | [< フォルダ一覧](../folders/Assets_TextMesh_Pro_Examples_&_Extras_Scripts.md)

> **Path:** `Assets/TextMesh Pro/Examples & Extras/Scripts/TMP_FrameRateCounter.cs`

<a id='TMP_FrameRateCounter'></a>
## Class TMP_FrameRateCounter
**Namespace:** `TMPro.Examples`<br>
**Signature:** `TMP_FrameRateCounter : MonoBehaviour`
